...
export const PlayerMonsterCard: React.FC<PlayerMonsterCardProps> = ({ monster }) => {
  ...
  return (
    <div className="bg-slate-900/80 border border-slate-700/60 rounded-lg p-2.5 text-xs text-slate-200 font-mono shadow-sm flex flex-wrap items-center justify-between gap-x-3 gap-y-1">
