      ...
      <div className="bg-slate-900 border border-slate-700/80 rounded-2xl max-w-[900px] w-full h-[85vh] shadow-2xl text-slate-100 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-12 gap-6 p-6 overflow-hidden bg-slate-950/40">
          ...
          <div className="md:col-span-6 border-r border-slate-800/80 pr-6 flex flex-col h-full overflow-hidden">
            {/* Master Account Pill Switch: [ 👤 Personal Heroes / My Heroes | 👑 Master Roster ] */}
            {isMasterAccount && (
              <div className="bg-slate-950/80 border border-slate-800/80 p-1 rounded-xl flex items-center gap-1 shadow-inner backdrop-blur-md mb-3 shrink-0">
                ...
                >
                  {activeRole === 'gm' ? '👤 Personal Heroes' : `👤 My Heroes (${userCharacters.length})`}
                </button>
                <button
                  type="button"
            ...
            {rosterMode === 'master_roster' && isMasterAccount ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-6 text-center bg-slate-900/80 rounded-2xl border border-amber-500/30 space-y-3 my-auto shadow-inner">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-400 max-w-xs leading-relaxed">
                    Toggle to 👤 Player in the header above to access personal heroes.
                  </p>
                </div>
              </div>
            ) : (
